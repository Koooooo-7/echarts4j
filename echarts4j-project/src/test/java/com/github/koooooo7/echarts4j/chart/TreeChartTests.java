...
import com.github.koooooo7.echarts4j.option.series.tree.TreeChartSeries;
                ...
                .addCharts(TreeChart.builder()
                        ...
                        .options(ChartOption.builder()
                                ...
                                .title(Title.builder()
                                        ...
                                        .build())
                                .build()
                                .addSeries(TreeChartSeries.builder()
                                        .data(Collections.singletonList(data))
                                        .top("1%")
                                        .left("7%")
                                        .bottom("1%")
                                        .right("20%")
                                        .symbolSize(FuncStr.of(7))
                                        .label(Label.builder()
                                                .position(FuncStr.ofStr("left"))
                                                .build())
                                        .leaves(TreeChartSeries.Leaves.builder()
                                                .label(Label.builder()
                                                        .position(FuncStr.ofStr("right"))
                                                        .build())
                                                .build())
                                        .expandAndCollapse(true)
                                        .animationDuration(FuncStr.of(550))
                                        .animationDurationUpdate(FuncStr.of(500))
                                        .build())
                        )
                        .build())
                .build()
                .renderTo(new File("tree.html"));

    }

//    @Test
//    void shouldGenerateTreeChart_WhenCallTheTreeChartConfig_GivenNecessaryConfigsAndFetchData() throws IOException {
//        final JsonMapper mapper = JsonMapper.builder().build();
//        final TreeChart.TreeDataItem data = mapper.readValue(MOCK_DATA, TreeChart.TreeDataItem.class);
//        Canvas.builder()
//                .addCharts(TreeChart.builder()
