...
//@SuperBuilder
//@Data
//public abstract class BaseChart<T extends Chart> extends Container implements Chart<T> {
//    @Builder.Default
...
//    }
//
//    public BaseChart addListener(String eventName, FuncStr query, FuncStr handler) {
