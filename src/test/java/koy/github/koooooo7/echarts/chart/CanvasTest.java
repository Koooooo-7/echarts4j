...
import koy.github.koooooo7.echarts.option.series.GenericSeriesOption;
import koy.github.koooooo7.echarts.render.Render;
import koy.github.koooooo7.echarts.render.RenderProvider;
...
class CanvasTest {
    ...
    void setUp() {
        ...
        x.clear();
        for (int i = 0; i < 20; i++) {
            data.add(ThreadLocalRandom.current().nextInt(100));
